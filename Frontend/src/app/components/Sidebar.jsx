...
export default function Sidebar() {
  return (
    <nav className="w-70 min-w-70 h-screen flex flex-col bg-surface/60 backdrop-blur-xl border-r border-white/10 shadow-[0_0_40px_rgba(124,58,237,0.05)] relative z-50">
      {/* Brand Header */}
