...
export default function ChatInput({ onSend, isLoading }) {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 py-6 px-8 bg-linear-to-t from-surface-container-lowest via-surface-container-lowest/60 to-transparent z-40">
          ...
          <button
            ...
            className={`w-10 h-10 rounded-full border-none flex items-center justify-center text-white shrink-0 transition-all duration-200 ${
              isLoading
                ...
                : 'bg-linear-to-r from-primary-container to-secondary-container cursor-pointer shadow-[0_4px_12px_rgba(124,58,237,0.4)] hover:shadow-[0_4px_20px_rgba(124,58,237,0.6)]'
            }`}
          >
            {isLoading ? (
